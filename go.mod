module github.com/gads-citron/terragrunt
...
require (
	...
	github.com/gads-citron/terratest v0.41.0
...
require (
	github.com/gads-citron/go-commons v0.17.1
	github.com/gads-citron/gruntwork-cli v0.7.0
